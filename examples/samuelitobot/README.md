# Conectar samuelitoRestoBar al CRM (Bot Gateway)

Estos 4 archivos se generaron a partir del código **original** de `samuelitoRestoBar` (no del de
...
Copia cada archivo en la misma ruta dentro del repo `samuelitoRestoBar`:
...
## Variables en Railway (servicio samuelitoRestoBar)

```
CRM_BASE_URL=https://<tu-crm>.up.railway.app
CRM_API_KEY=<apiKey del chatbot "Samuelito" creado en CRM → Chatbots>
...
y en **Atiende** elige el número de Samuelito. Las credenciales son distintas para cada bot.
